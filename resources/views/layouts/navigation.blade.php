            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @if(auth()->user()->role === 'admin')
                        ...
                        <x-nav-link :href="route('admin.school-profiles.index')" :active="request()->routeIs('admin.school-profiles.*')">
                            {{ __('Profil Sekolah') }}
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            @if(auth()->user()->role === 'admin')
                ...
                <x-responsive-nav-link :href="route('admin.school-profiles.index')" :active="request()->routeIs('admin.school-profiles.*')">
                    {{ __('Profil Sekolah') }}
                </x-responsive-nav-link>
