...
<div class="flex items-center gap-4">
    ...
    <div>
        ...
        <p class="text-slate-500 dark:text-slate-400 text-sm font-medium mt-1">
            Buat kegiatan ekstrakurikuler baru.
        </p>
    </div>
</div>
@endsection
...
@section('content')
<div class="max-w-4xl">
    <form action="{{ route('admin.ekstrakurikuler.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
        @csrf
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-6">
                <div class="bg-white dark:bg-slate-800 rounded-3xl p-8 shadow-sm border border-slate-100 dark:border-slate-700/50 space-y-6">
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" required placeholder="Contoh: Pramuka, Futsal, Rohis..."
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div class="p-6 bg-emerald-500/5 dark:bg-emerald-500/10 rounded-3xl border border-emerald-500/10">
                    <h4 class="text-[10px] font-black uppercase tracking-widest text-emerald-600 dark:text-emerald-400 mb-2">Tips</h4>
                    <p class="text-[11px] text-emerald-800/70 dark:text-emerald-400/70 leading-relaxed font-medium"> Gunakan foto dengan rasio 16:9 atau persegi untuk tampilan terbaik di website profil.</p>
                </div>
            </div>
        </div>
    </form>
